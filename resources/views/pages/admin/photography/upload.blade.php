            ...
            <div class="space-y-8 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div class="space-y-6">
                    <x-admin.form.group label="Image" required>
                        <x-admin.form.file-upload name="image" preview required />
                    </x-admin.form.group>

                    <x-admin.form.group label="Alt Text">
                        <x-admin.form.input name="alt_text" value="{{ old('alt_text') }}" placeholder="Alt Text" />
                    </x-admin.form.group>
                    ...
                    <div class="pt-8 space-y-6">
                        ...
                        <x-admin.form.textarea name="caption"
                            rows="6">{{ old('caption') }}</x-admin.form.textarea>
                    </div>
                </div>
            </div>
